...
export default function ServicesPage() {
    ...
    return (
        <div
            className={`min-h-screen bg-gray-50 flex flex-col ${isRtl ? 'rtl font-arabic' : 'ltr font-sans'}`}
            dir={isRtl ? 'rtl' : 'ltr'}
        >
            ...
            <main className="flex-1 max-w-7xl mx-auto w-full py-16 px-6 sm:px-12">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-extrabold text-primary-900 mb-4">{t('services')}</h2>
